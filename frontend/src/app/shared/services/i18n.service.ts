...
export class I18nService {
  ...
  private loadTranslations(): void {
    ...
    this.translations['es'] = {
      ...
      'common.close_viewer': 'CERRAR VISOR',
      'common.delete_selection': 'BORRAR SELECCIÓN',
      'common.view_assigned_studies': 'VER SOLO ESTUDIOS ASIGNADOS',
      'common.view_assigned_studies_tooltip': 'Mostrar solo los estudios asignados al usuario',
      ...
      'common.page': 'Página',
      'common.of': 'de',
      'common.items_per_page': 'Items por página',

      // Element Logs
      'logs.element_logs_title': 'Listado de logs del elemento',
      'logs.log_id': 'Log ID',
      'logs.datetime': 'Fecha y hora',
      'logs.event': 'Evento',
      'logs.user': 'Usuario',
      'logs.organization': 'Organización',
      'logs.ip_client': 'IP Cliente',
      'logs.machine': 'Máquina',
      'logs.amend': 'Enmienda',
      'logs.details': 'Detalles',
      'logs.no_data': '(Sin dato)',
      'logs.waiting_results': 'Aguarde, aún no hay resultados.',
      ...
      'pathologies.search': 'Buscar',
      'pathologies.status': 'Estado',
      'pathologies.actions': 'Acciones',
      ...
      'pathologies.no_data': '(Sin dato)',
      'pathologies.waiting_results': 'Aguarde, aún no hay resultados.',
      'pathologies.export_list': 'EXPORTAR LISTADO',
      'pathologies.edit': 'Editar',
      'pathologies.element_logs': 'Logs del elemento',
      ...
      'organizations.title': 'Listado de organizaciones',
      'organizations.form_title': 'Formulario de organizaciones',
      'organizations.search': 'Buscar',
      'organizations.status': 'Estado',
      'organizations.actions': 'Acciones',
      'organizations.short_name': 'Nombre corto',
      'organizations.name': 'Nombre',
      'organizations.oid': 'OID',
      'organizations.country': 'País',
      'organizations.structure_id': 'ID Estructura',
      'organizations.suffix': 'Sufijo',
      'organizations.active': 'Activo',
      'organizations.inactive': 'Inactivo',
      'organizations.no_data': '(Sin dato)',
      'organizations.waiting_results': 'Aguarde, aún no hay resultados.',
      'organizations.export_list': 'EXPORTAR LISTADO',
      'organizations.edit': 'Editar',
      'organizations.element_logs': 'Logs del elemento',
      'organizations.short_name_required': 'Nombre corto *',
      'organizations.short_name_placeholder': 'Ingrese el nombre corto',
      'organizations.name_required': 'Nombre *',
      'organizations.name_placeholder': 'Ingrese el nombre',
      'organizations.oid_placeholder': 'Ingrese el OID',
      'organizations.country_required': 'País de la organización *',
      'organizations.country_placeholder': 'País de la organización',
      'organizations.structure_id_placeholder': 'Ingrese el ID Estructura',
      'organizations.suffix_placeholder': 'Ingrese el Sufijo',
      'organizations.certificate_title': 'Certificado',
      'organizations.certificate_pk12': '.PK12',
      'organizations.organization_certificate': 'CERTIFICADO DE LA ORGANIZACIÓN',
      'organizations.delete_certificate_tooltip': 'Eliminar certificado de la organización',
      'organizations.select_certificate': 'SELECCIONAR CERTIFICADO DE LA ORGANIZACIÓN',
      'organizations.certificate_password': 'Clave del certificado',
      'organizations.certificate_password_placeholder': 'Ingrese clave del certificado.',
      'organizations.certificate_password_hint': 'Ya existe una clave de certificado en la base de datos, indique una solo si desea cambiarla.',
      'organizations.organization_logo': 'LOGO DE LA ORGANIZACIÓN',
      'organizations.delete_logo_tooltip': 'Eliminar logo de la organización',
      'organizations.select_logo': 'SELECCIONAR LOGO DE LA ORGANIZACIÓN',
      'organizations.cancel': 'CANCELAR',
      'organizations.save': 'GUARDAR',
      'procedure_categories.title': 'Listado de categorías de procedimientos',
      'procedure_categories.form_title': 'Formulario de categorías de procedimientos',
      'procedure_categories.search': 'Buscar',
      'procedure_categories.actions': 'Acciones',
      'procedure_categories.organization': 'Organización',
      'procedure_categories.branch': 'Sucursal',
      'procedure_categories.name': 'Nombre',
      'procedure_categories.procedures_count': 'Cantidad de procedimientos',
      'procedure_categories.procedures': 'Procedimientos',
      'procedure_categories.select_all_tooltip': 'Seleccionar todos (Página actual)',
      'procedure_categories.edit': 'Editar',
      'procedure_categories.element_logs': 'Logs del elemento',
      'procedure_categories.no_data': '(Sin dato)',
      'procedure_categories.waiting_results': 'Aguarde, aún no hay resultados.',
      'procedure_categories.export_list': 'EXPORTAR LISTADO',
      'procedure_categories.branch_required': 'Sucursal *',
      'procedure_categories.branch_placeholder': 'Seleccione la sucursal',
      'procedure_categories.name_required': 'Nombre *',
      'procedure_categories.name_placeholder': 'Ingrese el nombre',
      'procedure_categories.procedures_placeholder': 'Seleccione las modalidades',
      'procedure_categories.cancel': 'CANCELAR',
      'procedure_categories.save': 'GUARDAR',
      'equipments.title': 'Listado de equipamiento',
      'equipments.form_title': 'Formulario de equipamiento',
      'equipments.search': 'Buscar',
      'equipments.modality': 'Modalidad',
      'equipments.status': 'Estado',
      'equipments.actions': 'Acciones',
      'equipments.organization': 'Organización',
      'equipments.branch': 'Sucursal',
      'equipments.name': 'Nombre',
      'equipments.serial_number': 'S/N',
      'equipments.aet': 'AET',
      'equipments.modalities': 'Modalidades',
      'equipments.active': 'Activo',
      'equipments.inactive': 'Inactivo',
      'equipments.no_data': '(Sin dato)',
      'equipments.waiting_results': 'Aguarde, aún no hay resultados.',
      'equipments.export_list': 'EXPORTAR LISTADO',
      'equipments.edit': 'Editar',
      'equipments.element_logs': 'Logs del elemento',
      'equipments.branch_required': 'Sucursal *',
      'equipments.branch_placeholder': 'Seleccione la sucursal',
      'equipments.modalities_required': 'Modalidades *',
      'equipments.modalities_placeholder': 'Seleccione las modalidades',
      'equipments.name_required': 'Nombre *',
      'equipments.name_placeholder': 'Ingrese el nombre',
      'equipments.serial_number_placeholder': 'Ingrese el número de serie',
      ...
      'billing.select_date_range': 'Seleccione rango de fechas',
      'billing.element_flow': 'Flujo del elemento',
      'billing.completed': 'Completado',
      'billing.completion_date': 'Fecha de finalización',
      'billing.report_date': 'Fecha de informe',
      'billing.days_elapsed': 'Días transcurridos',
      'billing.no_data': '(Sin dato)',
      'billing.waiting_results': 'Aguarde, aún no hay resultados.',
      'billing.export_list': 'EXPORTAR LISTADO',
      'billing.edit': 'Editar',
      'billing.element_logs': 'Logs del elemento',
      'billing.no_requires_report': 'NO REQUIERE INFORME',
      'billing.no': 'NO',
      'billing.yes': 'SI',
      'billing.requested': 'Solicitada',
    ...
    this.translations['en'] = {
      ...
      'common.close_viewer': 'CLOSE VIEWER',
      'common.delete_selection': 'DELETE SELECTION',
      'common.view_assigned_studies': 'VIEW ASSIGNED STUDIES ONLY',
      'common.view_assigned_studies_tooltip': 'Show only studies assigned to the user',
      ...
      // Element Logs
      'logs.element_logs_title': 'Element Logs List',
      'logs.log_id': 'Log ID',
      'logs.datetime': 'Date and Time',
      'logs.event': 'Event',
      'logs.user': 'User',
      'logs.organization': 'Organization',
      'logs.ip_client': 'Client IP',
      'logs.machine': 'Machine',
      'logs.amend': 'Amendment',
      'logs.details': 'Details',
      'logs.no_data': '(No data)',
      'logs.waiting_results': 'Please wait, no results yet.',
      ...
      'pathologies.search': 'Search',
      'pathologies.status': 'Status',
      'pathologies.actions': 'Actions',
      ...
      'pathologies.no_data': '(No data)',
      'pathologies.waiting_results': 'Please wait, no results yet.',
      'pathologies.export_list': 'EXPORT LIST',
      'pathologies.edit': 'Edit',
      'pathologies.element_logs': 'Element logs',
      ...
      'branches.save': 'SAVE',
      'organizations.title': 'Organizations List',
      'organizations.form_title': 'Organizations Form',
      'organizations.search': 'Search',
      'organizations.status': 'Status',
      'organizations.actions': 'Actions',
      'organizations.short_name': 'Short Name',
      'organizations.name': 'Name',
      'organizations.oid': 'OID',
      'organizations.country': 'Country',
      'organizations.structure_id': 'Structure ID',
      'organizations.suffix': 'Suffix',
      'organizations.active': 'Active',
      'organizations.inactive': 'Inactive',
      'organizations.no_data': '(No data)',
      'organizations.waiting_results': 'Please wait, no results yet.',
      'organizations.export_list': 'EXPORT LIST',
      'organizations.edit': 'Edit',
      'organizations.element_logs': 'Element logs',
      'organizations.short_name_required': 'Short Name *',
      'organizations.short_name_placeholder': 'Enter the short name',
      'organizations.name_required': 'Name *',
      'organizations.name_placeholder': 'Enter the name',
      'organizations.oid_placeholder': 'Enter the OID',
      'organizations.country_required': 'Organization Country *',
      'organizations.country_placeholder': 'Organization Country',
      'organizations.structure_id_placeholder': 'Enter the Structure ID',
      'organizations.suffix_placeholder': 'Enter the Suffix',
      'organizations.certificate_title': 'Certificate',
      'organizations.certificate_pk12': '.PK12',
      'organizations.organization_certificate': 'ORGANIZATION CERTIFICATE',
      'organizations.delete_certificate_tooltip': 'Delete organization certificate',
      'organizations.select_certificate': 'SELECT ORGANIZATION CERTIFICATE',
      'organizations.certificate_password': 'Certificate password',
      'organizations.certificate_password_placeholder': 'Enter certificate password.',
      'organizations.certificate_password_hint': 'A certificate password already exists in the database, enter one only if you want to change it.',
      'organizations.organization_logo': 'ORGANIZATION LOGO',
      'organizations.delete_logo_tooltip': 'Delete organization logo',
      'organizations.select_logo': 'SELECT ORGANIZATION LOGO',
      'organizations.cancel': 'CANCEL',
      'organizations.save': 'SAVE',
      'procedure_categories.title': 'Procedure Categories List',
      'procedure_categories.form_title': 'Procedure Categories Form',
      'procedure_categories.search': 'Search',
      'procedure_categories.actions': 'Actions',
      'procedure_categories.organization': 'Organization',
      'procedure_categories.branch': 'Branch',
      'procedure_categories.name': 'Name',
      'procedure_categories.procedures_count': 'Number of Procedures',
      'procedure_categories.procedures': 'Procedures',
      'procedure_categories.select_all_tooltip': 'Select all (Current page)',
      'procedure_categories.edit': 'Edit',
      'procedure_categories.element_logs': 'Element logs',
      'procedure_categories.no_data': '(No data)',
      'procedure_categories.waiting_results': 'Please wait, no results yet.',
      'procedure_categories.export_list': 'EXPORT LIST',
      'procedure_categories.branch_required': 'Branch *',
      'procedure_categories.branch_placeholder': 'Select branch',
      'procedure_categories.name_required': 'Name *',
      'procedure_categories.name_placeholder': 'Enter the name',
      'procedure_categories.procedures_placeholder': 'Select procedures',
      'procedure_categories.cancel': 'CANCEL',
      'procedure_categories.save': 'SAVE',
      'equipments.title': 'Equipment List',
      'equipments.form_title': 'Equipment Form',
      'equipments.search': 'Search',
      'equipments.modality': 'Modality',
      'equipments.status': 'Status',
      'equipments.actions': 'Actions',
      'equipments.organization': 'Organization',
      'equipments.branch': 'Branch',
      'equipments.name': 'Name',
      'equipments.serial_number': 'S/N',
      'equipments.aet': 'AET',
      'equipments.modalities': 'Modalities',
      'equipments.active': 'Active',
      'equipments.inactive': 'Inactive',
      'equipments.no_data': '(No data)',
      'equipments.waiting_results': 'Please wait, no results yet.',
      'equipments.export_list': 'EXPORT LIST',
      'equipments.edit': 'Edit',
      'equipments.element_logs': 'Element logs',
      'equipments.branch_required': 'Branch *',
      'equipments.branch_placeholder': 'Select branch',
      'equipments.modalities_required': 'Modalities *',
      'equipments.modalities_placeholder': 'Select modalities',
      'equipments.name_required': 'Name *',
      'equipments.name_placeholder': 'Enter the name',
      'equipments.serial_number_placeholder': 'Enter the serial number',
      ...
      'billing.select_date_range': 'Select date range',
      'billing.element_flow': 'Element flow',
      ...
      'billing.edit': 'Edit',
      'billing.element_logs': 'Element logs',
      'billing.no_requires_report': 'NO REPORT REQUIRED',
      'billing.no': 'NO',
      'billing.yes': 'YES',
      'billing.requested': 'Requested',
